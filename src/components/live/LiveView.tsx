...
export function LiveView() {
  ...
  const [minutesBeforeDeparture, setMinutesBeforeDeparture] = useState(
    DEFAULT_MINUTES_BEFORE,
  );
  const [minutesAfterDeparture, setMinutesAfterDeparture] = useState(
  ...
  const windowStart = new Date(
    now.getTime() - minutesBeforeDeparture * 60 * 1000,
  );
  const windowEnd = new Date(
    now.getTime() + minutesAfterDeparture * 60 * 1000,
  );
              ...
              >
                  ...
                  <Stack gap="md">
                    ...
                    {lastUpdated && (
                      <Text size="xs" c="dimmed" ta="center">
                        Last updated:{" "}
                        {formatFinnishTime(lastUpdated.toISOString())}
                      </Text>
                    )}
                  </Stack>
                )}
                ...
                {isFetched &&
                  ...
                  !hasData && (
                    ...
                    >
                      <Text c="dimmed">
                        No trains found for this direction right now.
                      </Text>
                    </Center>
                  )}
          </Stack>
